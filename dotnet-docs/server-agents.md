...
>important The Report Server for .NET should be completely setup and configured before adding Server Agents - [Installing ReportServer.NET on Docker Containe]({%slug dotnet-installation-on-docker-container%}).
