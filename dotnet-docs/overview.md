...
The Report Server Manager is an [ASP.NET Core Application](https://dotnet.microsoft.com/en-us/apps/aspnet) that allows Report Server users to log in and use its functionality through a user-friendly interface which is built with [Kendo UI 2024 Q1 (version 2024.1.130)](<https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-2024-q1-(version-2024-1-130)>).

The Web UI provides a dedicated view for each functionality of the server.
