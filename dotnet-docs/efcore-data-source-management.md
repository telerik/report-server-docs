...
1. Create a new [EntityCoreDataSource Component](https://www.telerik.com/products/reporting/documentation/designing-reports/connecting-to-data/data-source-components/entitycoredatasource-component/overview) and follow the [EntityCoreDataSource Wizard](https://www.telerik.com/products/reporting/documentation/designing-reports/connecting-to-data/data-source-components/entitycoredatasource-component/connecting-to-a-dbcontext-with-the-entitycoredatasource-component) to select a `DbContext` type, a data-retrieval member, and configure any data source parameters.
