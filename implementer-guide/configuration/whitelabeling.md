...
> note Starting with the [2025 Q3](https://www.telerik.com/support/whats-new/report-server/release-history/progress-telerik-report-server-2025-q3-11-2-25-813) release, the whitelabeling functionality is now also available in the [Report Server for .NET]({%slug report-server-net-overview%}) - [Whitelabeling in the Report Server for .NET]({%slug dotnet-server-whitelabeling%}).
