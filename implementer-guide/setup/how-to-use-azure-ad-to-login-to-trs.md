...
Those two fields must match and it's not mandatory to use the actual server URL.
...
With this step the authentication configurations for both the Azure application and Telerik Report Server are complete. At this point, you should be able to log in to Report Server using the web interface, by clicking on the blue button "**Active Directory Credentials**" on the login screen.
