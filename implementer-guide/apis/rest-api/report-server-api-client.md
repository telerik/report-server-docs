...
The Report Server API client is a .NET library that comes in handy when developing .NET applications which would connect to the [Report Server API](slug:rs-v2-api-reference).
