...
$(function () {
      ...
      function loadToc() {
          ...
          $('#sidetoc').load(tocPath + " #sidetoggle > div", function () {
              ...
              $('#sidetoc').find('a[href]').each(function (i, e) {
                  ...
                  if (util.getAbsolutePath(e.href).toLowerCase().split('.html')[0] === currentHref.toLowerCase().split('.html')[0]) {
                      $(e).addClass(active);
                  }
  ...
  function renderAffix() {
      ...
      function getHierarchy() {
          // supported headers are h1, h2, h3
