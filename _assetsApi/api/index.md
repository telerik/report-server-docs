...
# Telerik Report Server API Reference

The API reference section of the documentation contains a list and descriptions of all public available classes, methods and properties of the Telerik Report Server product.

> This documentation refers to the latest version of Telerik Report Server.
