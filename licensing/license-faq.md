...
- _Perpetual licenses_ function normally with an expired license key, as long as the application is using a Telerik Report Server version that was released before the expiration date of the license.
...
1. [Activate the new license key]({%slug license-key%}#activating-telerik-report-server-q2-2025-release-and-onwards) in your project.
